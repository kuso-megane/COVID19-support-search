...
class SupportOrgsTable
{
     ...
     */
    public function findSearchedOnes(string $meta_word, int $area_id, bool $is_only_foreign_ok, bool $is_public): ?array
    {
        ...
        $records = $this->dbh
        ->select($columns, $this::TABLENAME, $condition, ['orderby' => 'id', 'sort' => 'ASC'], $boundValues);
